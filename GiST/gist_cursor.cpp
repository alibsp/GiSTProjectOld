...
Aldaghi::Aldaghi() : typ(eIllegal) {}
/*
Aldaghi::~Aldaghi() {}

Aldaghi &Aldaghi::operator=(const Aldaghi &e)
{

}

/*Aldaghi::Aldaghi(shpid_t page, shpid_t parent): typ(eNode)
{
    val.node.page = page;
#ifdef AMDB
    val.node.parent = parent;
...
Aldaghi::Aldaghi(void *key, smsize_t klen, void *data, smsize_t dlen, shpid_t page, int idx)
{
